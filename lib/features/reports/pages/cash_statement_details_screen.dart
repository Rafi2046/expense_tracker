...
class CashStatementDetailsScreen extends StatelessWidget {
  final bool isMasked;

  const CashStatementDetailsScreen({super.key, this.isMasked = false});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          context.translate('all_transactions'),
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) => CashStatementList.buildTxCard(context, filtered[index], isMasked),
      ),
    );
  }
}