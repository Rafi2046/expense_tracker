                ...
                children: [
                  ...
                  SizedBox(width: AppSpacing.s48,
                    child: Text(
                      ...
                      style: AppTextStyles.caption.copyWith( fontWeight: FontWeight.w500, color: isDark ? Colors.white70 : const Color(0xFFDC3545)),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  SizedBox(width: AppSpacing.s48,
                    child: Text(
                      ...
                      maxLines: 1, overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.center,
                      style: AppTextStyles.caption.copyWith( fontWeight: FontWeight.w500, color: AppColors.activeGreen),
                    ),
                  ),
                ],
              ),
