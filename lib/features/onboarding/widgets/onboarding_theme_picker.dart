...
class OnboardingThemePicker extends StatefulWidget {
  ...
  const OnboardingThemePicker({super.key, required this.isDark});

  @override
  State<OnboardingThemePicker> createState() => _OnboardingThemePickerState();
}

class _OnboardingThemePickerState extends State<OnboardingThemePicker>
      ...
      child: Stack(
        ...
        children: [
          ...
          Container(
            ...
            child: const Icon(LucideIcons.paintbrush, size: 34, color: Colors.white),
          ),
        ],
      ),
    );
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            // Icon in gradient container when selected
            AnimatedContainer(
              duration: const Duration(milliseconds: 250),
              width: 44,
              height: 44,
